...
On my machine, [criterium](https://github.com/hugoduncan/criterium) measured 76ms (±1ms) for a `reset!` and 140ms (±9ms) for a `swap!` of 20mb worth of EDN from a Datascript backup.
