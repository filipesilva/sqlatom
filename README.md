...
On my machine, [criterium](https://github.com/hugoduncan/criterium) measured 195ms (±3ms) for a `reset!` and 273ms (±14ms) for a `swap!` of 20mb worth of EDN from a Datascript backup.
